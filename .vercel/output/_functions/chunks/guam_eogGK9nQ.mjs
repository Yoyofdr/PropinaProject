const country = "Guam";
const slug = "pourboire-au-guam";
const language = "fr";
const tip_percentages = {"restaurant":10,"bar":10,"hotel":10,"taxi":0};
const faq = [{"q":"Le pourboire est-il obligatoire en Guam ?","a":"Le pourboire n'est pas obligatoire, mais il est d'usage de laisser entre 10% et 15% dans les restaurants."}];

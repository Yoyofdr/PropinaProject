...
const slug = "tipping-in-curacao";
const language = "nl";
const tip_percentages = {"restaurant":10,"bar":10,"hotel":10,"taxi":0};
const faq = [{"q":"Is tipping mandatory in Curaçao?","a":"Tipping is not mandatory, but it is customary to leave between 10% and 15% in restaurants."}];
